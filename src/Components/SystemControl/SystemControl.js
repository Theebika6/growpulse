                    ...
                    <tr className="sub-menu">
                        ...
                        <td className="toggle-cell">
                            ...
                            >
                                ...
                                <span className="auto-label" style={{ color: phBalanceAuto ? 'rgba(0, 210, 4)' : "grey" }}>A</span>
                            </button>
                        </td>
                    </tr>
                    <tr className="sub-menu">
                        ...
                        <td className="toggle-cell">
                            ...
                            >
                                ...
                                <span className="auto-label" style={{ color: lightScheduleAuto ? 'rgba(0, 210, 4)' : 'grey' }}>A</span>
                            </button>
                        </td>
                    </tr>
                    <tr className="sub-menu">
                        ...
                        <td className="toggle-cell">
                            <button className="toggle-button" onClick={() => toggleAutomationHumidity(humidityControlAuto, setHumidityControlAuto, systemName)}>
                                ...
                                <span className="auto-label" style={{ color: humidityControlAuto ? 'rgba(0, 210, 4)' : 'grey' }}>A</span>
                            </button>
                        </td>
                    </tr>
                    ...
                    <tr className="sub-menu">
                        ...
                        <td className="toggle-cell">
                            <button className="toggle-button-Init-Dosing" onClick={() => toggleStartInitialDosing(startInitialDosing, setStartInitialDosing, systemName)}>
                                ...
                                <span className="auto-label" style={{ color: startInitialDosing ? 'rgba(0, 210, 4)' : 'grey' }}>Start</span>
                            </button>
                        </td>
                    </tr>
                    <tr className="sub-menu">
                    ...
                    <tr className="sub-menu">
                        ...
                        <td className="toggle-cell">
                            <button className="toggle-button" onClick={() => setDispensePumpA(!dispensePumpA)}>
                                ...
                                <span className="auto-label" style={{ color: dispensePumpA ? 'rgba(0, 210, 4)' : 'grey' }}>Run</span>
                            </button>
                        </td>
                    </tr>
                    <tr className="sub-menu">
                        ...
                        <td className="toggle-cell">
                            <button className="toggle-button" onClick={() => setDispensePumpB(!dispensePumpB)}>
                                ...
                                <span className="auto-label" style={{ color: dispensePumpB ? 'rgba(0, 210, 4)' : 'grey' }}>Run</span>
                            </button>
                        </td>
                    </tr>
                    <tr className="sub-menu">
                        ...
                        <td className="toggle-cell">
                            <button className="toggle-button" onClick={() => setDispensePumpC(!dispensePumpC)}>
                                ...
                                <span className="auto-label" style={{ color: dispensePumpC ? 'rgba(0, 210, 4)' : 'grey' }}>Run</span>
                            </button>
                        </td>
                    </tr>
                    <tr className="sub-menu">
                        ...
                        <td className="toggle-cell">
                            <button className="toggle-button" onClick={() => setDispensePumpD(!dispensePumpD)}>
                                ...
                                <span className="auto-label" style={{ color: dispensePumpD ? 'rgba(0, 210, 4)' : 'grey' }}>Run</span>
                            </button>
                        </td>
                    </tr>
                    </tbody>
